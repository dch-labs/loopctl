...
/// - [`session_id`](ToolDispatchContext::session_id) — Session ID from config.
...
pub struct ToolDispatchContext {
    ...
    ///
    /// Identifies the agent session this call belongs to. Middlewares
    /// can use this for logging, rate limiting, or audit trails.
    pub session_id: Uuid,
